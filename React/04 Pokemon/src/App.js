        ...
        <div className="App">
            ...
            {show && (
                <div className="pokemon">
                    ...
                    />
                    <div className="stats">
                        <p>{`${stats[1].stat.name.toUpperCase()} : ${
                            stats[1].base_stat
                        }`}</p>
                        <p>{`${stats[3].stat.name.toUpperCase()} : ${
                            stats[3].base_stat
                        }`}</p>
                        <p>{`${stats[2].stat.name.toUpperCase()} : ${
                            stats[2].base_stat
                        }`}</p>
                        <p>{`${stats[4].stat.name.toUpperCase()} : ${
                            stats[4].base_stat
                        }`}</p>
                        <p>{`${stats[5].stat.name.toUpperCase()} : ${
                            stats[5].base_stat
                        }`}</p>
            ...
            {error && <p>{pokemonQuery} is not found</p>}
        </div>
    );
}
